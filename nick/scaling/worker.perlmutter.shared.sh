...
srun -n 1 -c 128 --cpu_bind=rank_ldom --overlap ./multicore-test-bind -e 2000 -s 2 -t $NUM_THREADS ./data-ai-multicore.yaml ./clas_006302.evio.00005-00009.hipo /pscratch/sd/t/tylern/clas12/recon/test.hipo
